...
<html lang="es">
<head>
	<title>PRUEBA DE EJERCISIOS #2</title>
	...
	<script type="text/javascript"  src="script_ejercisios2.js"></script>
...
<div id="container">
	...
	<header>
		<center><h2>PRUEBA DE EJERCISIOS #2</h2></center>
		<center><h4>Aplica lo que aprendes<br>Con la siguiente prueba</strong></h4></center>
	</header>
	<section>
		<div id="results"></div>
		<form name="quizForm" onsubmit="return submitAnswers()">
			<h3>1. Se arroja una pelota hacia arriba de forma recta desde el punto A, alcanza una altura máxima en el punto B y vuelve a caer al punto C. ¿Cuál de los siguientes enunciados es verdadero acerca de la velocidad y aceleración de la pelota en el punto más alto B?:</h3>
			<input type="radio" name="q1" value="a" id="q1a">A. &lt; Su velocidad y aceleración son igual a cero&gt;<br>
			<input type="radio" name="q1" value="b" id="q1b">B. &lt; Su velocidad aumenta, y la constante es diferente de cero y la aceleración es cero &gt;<br>
			<input type="radio" name="q1" value="c" id="q1c">C. &lt; Su velocidad disminuye, y la constante es diferente de cero y la aceleración es cero &gt;<br>
			<input type="radio" name="q1" value="d" id="q1d">D. &lt; Su velocidad es cero y la aceleración aumenta y la constante es diferente de cero &gt;<br>
			<input type="radio" name="q1" value="e" id="q1e">E. &lt; Su velocidad es cero y la aceleración disminuye y la constante es diferente de cero &gt;<br><br><hr>

			<h3>2. Una pelota, un disco de hockey y una pelota de tenis caen en laausencia de resistencia de aire. ¿Cuál de los siguientes enunciados es verdadero acerca de su aceleración?</h3>
			<input type="radio" name="q2" value="a" id="q2a">A.  La aceleración de la pelota es mayor que los otros dos  <br>
			<input type="radio" name="q2" value="b" id="q2b">B.  La aceleración del disco de hockey es mayor que los otros dos  <br>
			<input type="radio" name="q2" value="c" id="q2c">C.  La aceleración de la pelota de tenis es mayor que los otros dos  <br>
			<input type="radio" name="q2" value="d" id="q2d">D.  Todos caen con la misma aceleración constante  <br>
			<input type="radio" name="q2" value="e" id="q2d">E.  Se necesita más información <br><br><hr>

			<h3>3. Un paquete se arroja dos veces desde un globo de aire. En el primer intento, la distancia entre el globo y la superficie es H y en el segundo intento 4H. Compara el tiempo que demora que un paquete alcance la superficie en el segundo intento con el primer intento.</h3>
			<input type="radio" name="q3" value="a" id="q3a">A. El tiempo en el segundo intento es cuatro veces mayor <br>
			<input type="radio" name="q3" value="b" id="q3b">B. El tiempo en el segundo intento es dos veces mayor <br>
			<input type="radio" name="q3" value="c" id="q3c">C. El tiempo es igual en ambos intentos debido a que no <br>
			<input type="radio" name="q3" value="d" id="q2d">D. El tiempo en el segundo intento es cuatro veces menor <br>
			<input type="radio" name="q3" value="e" id="q2e">E. El tiempo en el segundo intento es dos veces menor  <br><br><hr>

			<h3>4. Dos pelotas de béisbol se arrojan desde el techo de una casa con la misma rapidez inicial, una se arroja hacia arriba y la otra hacia abajo. Compara la rapidez de las pelotas de béisbol antes de que golpeen el piso.</h3>
